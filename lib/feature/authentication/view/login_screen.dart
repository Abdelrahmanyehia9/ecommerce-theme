            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 18,),
                  CustomTextField(hint: "Enter your email address", label: "Email", controller: emailController,
                  validation: (value)=>Validation.validateEmail(value??""),) ,
                  CustomTextField(hint: "Enter your Password", label: "Password", controller: passwordController,
                  validation: (value)=> Validation.validatePassword(value??""),) ,
                  Padding(
                    padding: EdgeInsets.only(bottom: 24.0 , top:  8  , left: 8  , right: 8),
                    child: TextButtonLabeled (hint: "Forgot you password", label: "Reset password", isPasswordReset :true ,onTap: (){
                      Navigator.pushNamed(context, AppRouter.forgetPassword) ;
                    },),
                  )  ,
                  BigButton(label: "Login" , onTap: (){
                  ...
                  BigIconSocialButton(label: "Login with Google" , svgPath: AppConstants.googleSvg,),
                  Padding(
